# Espressif Systems Github Star Rank 2024-12-05

## Total Star 🌟: 69605, Total Fork 🌳: 29365
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 13913 | 7332 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 13785 | 7442 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5613 | 1387 | Espressif SoC serial bootloader utility |
| [ESP8266_RTOS_SDK](https://github.com/espressif/ESP8266_RTOS_SDK) | 3349 | 1564 | Latest ESP8266 SDK based on FreeRTOS, esp-idf style. |
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2001 | 789 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 1953 | 648 | None |
| [esp-who](https://github.com/espressif/esp-who) | 1712 | 469 | Face detection and recognition framework |
| [esp-adf](https://github.com/espressif/esp-adf) | 1569 | 690 | Espressif Audio Development Framework |
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1083 | 307 | Visual Studio Code extension for ESP-IDF projects |
| [ESP8266_NONOS_SDK](https://github.com/espressif/ESP8266_NONOS_SDK) | 932 | 536 | ESP8266 nonOS SDK |
| [esp-at](https://github.com/espressif/esp-at) | 920 | 835 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [esp-drone](https://github.com/espressif/esp-drone) | 841 | 243 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-box](https://github.com/espressif/esp-box) | 817 | 191 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
...
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 779 | 109 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
...
| [esp-csi](https://github.com/espressif/esp-csi) | 726 | 110 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
| [esp-hosted](https://github.com/espressif/esp-hosted) | 715 | 170 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
| [esp-matter](https://github.com/espressif/esp-matter) | 709 | 162 | Espressif's SDK for Matter |
...
| [esp-sr](https://github.com/espressif/esp-sr) | 594 | 107 | Speech recognition |
...
| [esp-homekit-sdk](https://github.com/espressif/esp-homekit-sdk) | 570 | 109 | None |
| [esp-now](https://github.com/espressif/esp-now) | 551 | 97 | A connectionless Wi-Fi communication protocol |
...
| [esp-rainmaker](https://github.com/espressif/esp-rainmaker) | 470 | 154 | ESP RainMaker Agent for firmware development |
| [rust-esp32-example](https://github.com/espressif/rust-esp32-example) | 448 | 36 | Example of Rust integration into an ESP-IDF project, for ESP32 series of chips |
| [esp-tflite-micro](https://github.com/espressif/esp-tflite-micro) | 398 | 86 | TensorFlow Lite Micro for Espressif Chipsets |
| [esp-serial-flasher](https://github.com/espressif/esp-serial-flasher) | 392 | 113 | Library for flashing Espressif SoCs from other MCUs. |
...
| [idf-eclipse-plugin](https://github.com/espressif/idf-eclipse-plugin) | 315 | 121 | Espressif-IDE (ESP-IDF Eclipse Plugin) for ESP-IDF CMake based projects 5.x and above |
| [esp-usb-bridge](https://github.com/espressif/esp-usb-bridge) | 302 | 34 | USB to UART&JTAG bridge, implemented on ESP32-S2 or ESP32-S3 |
...
| [esptool-js](https://github.com/espressif/esptool-js) | 292 | 109 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
| [esp-aws-iot](https://github.com/espressif/esp-aws-iot) | 273 | 164 | AWS IoT SDK for ESP32 based chipsets |
| [esp-bsp](https://github.com/espressif/esp-bsp) | 208 | 108 | Board support components for Espressif development boards |
| [esp-idf-provisioning-android](https://github.com/espressif/esp-idf-provisioning-android) | 204 | 136 | Android Provisioning application for ESP-IDF Unified provisioning |
...
| [esp-jumpstart](https://github.com/espressif/esp-jumpstart) | 178 | 58 | Jumpstart from concept to production |
...
| [esp-iot-bridge](https://github.com/espressif/esp-iot-bridge) | 166 | 54 | A smart bridge to make both ESP and the other MCU or smart device can access the Internet. |
...
| [esp32-arduino-lib-builder](https://github.com/espressif/esp32-arduino-lib-builder) | 153 | 170 | None |
...
| [esp-thread-br](https://github.com/espressif/esp-thread-br) | 117 | 26 | Espressif Thread Border Router SDK |
...
| [esp-wasmachine](https://github.com/espressif/esp-wasmachine) | 79 | 6 | The Machine which can run WASM applications. |
...
| [esp-brookesia](https://github.com/espressif/esp-brookesia) | 60 | 10 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
...
| [esp-wdf](https://github.com/espressif/esp-wdf) | 36 | 1 | Espressif WASM Development Framework. |
...
| [esp-eth-drivers](https://github.com/espressif/esp-eth-drivers) | 29 | 16 | Collection of additional Ethernet drivers for ESP-IDF |
...
| [esp-video-components](https://github.com/espressif/esp-video-components) | 10 | 1 | Collections of components to be used for camera related functionalities. |
...
| [esp-gmf](https://github.com/espressif/esp-gmf) | 3 | 0 | Espressif General Multimedia Framework (ESP-GMF) |
