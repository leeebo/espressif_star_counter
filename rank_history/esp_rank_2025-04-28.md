# Espressif Systems Github Star Rank 2025-04-28

## Total Star 🌟: 75846, Total Fork 🌳: 30839
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 15068 | 7613 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 14688 | 7598 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5836 | 1421 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
...
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2195 | 844 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 2180 | 686 | None |
| [esp-adf](https://github.com/espressif/esp-adf) | 1866 | 757 | Espressif Audio Development Framework |
| [esp-who](https://github.com/espressif/esp-who) | 1817 | 483 | Face detection and recognition framework |
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1197 | 320 | Visual Studio Code extension for ESP-IDF projects |
| [esp-drone](https://github.com/espressif/esp-drone) | 1063 | 279 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-at](https://github.com/espressif/esp-at) | 996 | 948 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [esp-box](https://github.com/espressif/esp-box) | 978 | 222 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
| [ESP8266_NONOS_SDK](https://github.com/espressif/ESP8266_NONOS_SDK) | 953 | 542 | ESP8266 nonOS SDK |
| [esp-sr](https://github.com/espressif/esp-sr) | 897 | 138 | Speech recognition |
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 882 | 118 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
| [esp-matter](https://github.com/espressif/esp-matter) | 815 | 185 | Espressif's SDK for Matter |
| [esp-mdf](https://github.com/espressif/esp-mdf) | 806 | 253 | Espressif Mesh Development Framework, limited maintain, recommend to use https://github.com/espressif/esp-mesh-lite |
| [esp-hosted](https://github.com/espressif/esp-hosted) | 791 | 185 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
| [esp-csi](https://github.com/espressif/esp-csi) | 779 | 118 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
| [ESP8266_MP3_DECODER](https://github.com/espressif/ESP8266_MP3_DECODER) | 753 | 192 | A demo that should be run with ESP8266 Non-OS SDK |
| [esp-dl](https://github.com/espressif/esp-dl) | 692 | 139 | Espressif deep-learning library for AIoT applications |
| [esp-skainet](https://github.com/espressif/esp-skainet) | 690 | 155 | Espressif intelligent voice assistant |
| [esp-mqtt](https://github.com/espressif/esp-mqtt) | 645 | 262 | ESP32 mqtt component |
| [esp-apple-homekit-adk](https://github.com/espressif/esp-apple-homekit-adk) | 635 | 69 | This is a port for Apple's Open Source HomeKit ADK |
| [esp-homekit-sdk](https://github.com/espressif/esp-homekit-sdk) | 607 | 115 | None |
| [esp-now](https://github.com/espressif/esp-now) | 603 | 108 | A connectionless Wi-Fi communication protocol |
| [esp32-nesemu](https://github.com/espressif/esp32-nesemu) | 571 | 175 | Proof-of-concept NES emulator for the ESP32 |
| [esp-dsp](https://github.com/espressif/esp-dsp) | 543 | 97 | DSP library for ESP-IDF |
| [esp-rainmaker](https://github.com/espressif/esp-rainmaker) | 512 | 171 | ESP RainMaker Agent for firmware development |
| [rust-esp32-example](https://github.com/espressif/rust-esp32-example) | 474 | 39 | Example of Rust integration into an ESP-IDF project, for ESP32 series of chips |
...
| [esp-tflite-micro](https://github.com/espressif/esp-tflite-micro) | 469 | 102 | TensorFlow Lite Micro for Espressif Chipsets |
| [esp-serial-flasher](https://github.com/espressif/esp-serial-flasher) | 442 | 124 | Library for flashing Espressif SoCs from other MCUs. |
| [esp-dev-kits](https://github.com/espressif/esp-dev-kits) | 435 | 192 | Docs, Schematics, Factory Firmwares for ESP Development Kits |
...
| [esptool-js](https://github.com/espressif/esptool-js) | 345 | 117 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
...
| [esp-bsp](https://github.com/espressif/esp-bsp) | 260 | 143 | Board support components for Espressif development boards |
...
| [esp32-wifi-lib](https://github.com/espressif/esp32-wifi-lib) | 173 | 73 | ESP32 WiFi stack precompiled libraries |
...
| [esp-webrtc-solution](https://github.com/espressif/esp-webrtc-solution) | 123 | 15 | None |
