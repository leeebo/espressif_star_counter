# Espressif Systems Github Star Rank 2025-09-07

## Total Star 🌟: 81434, Total Fork 🌳: 32150
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 16177 | 7844 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 15334 | 7702 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 6033 | 1445 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
| [ESP8266_RTOS_SDK](https://github.com/espressif/ESP8266_RTOS_SDK) | 3470 | 1599 | Latest ESP8266 SDK based on FreeRTOS, esp-idf style. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 2354 | 720 | None |
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2341 | 893 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp-adf](https://github.com/espressif/esp-adf) | 2027 | 796 | Espressif Advanced Development Framework for Multimedia Applications |
| [esp-who](https://github.com/espressif/esp-who) | 1903 | 504 | Face detection and recognition framework |
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1288 | 335 | Visual Studio Code extension for ESP-IDF projects |
| [esp-drone](https://github.com/espressif/esp-drone) | 1232 | 322 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-box](https://github.com/espressif/esp-box) | 1089 | 245 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
| [esp-sr](https://github.com/espressif/esp-sr) | 1083 | 161 | Speech recognition |
| [esp-at](https://github.com/espressif/esp-at) | 1075 | 1055 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 977 | 132 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
| [ESP8266_NONOS_SDK](https://github.com/espressif/ESP8266_NONOS_SDK) | 963 | 543 | ESP8266 nonOS SDK |
| [esp-csi](https://github.com/espressif/esp-csi) | 899 | 126 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
| [esp-matter](https://github.com/espressif/esp-matter) | 876 | 199 | Espressif's SDK for Matter |
| [esp-hosted](https://github.com/espressif/esp-hosted) | 875 | 201 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
...
| [esp-dl](https://github.com/espressif/esp-dl) | 791 | 155 | Espressif deep-learning library for AIoT applications |
| [esp-skainet](https://github.com/espressif/esp-skainet) | 759 | 171 | Espressif intelligent voice assistant |
...
| [esp-mqtt](https://github.com/espressif/esp-mqtt) | 670 | 271 | ESP32 mqtt component |
| [esp-now](https://github.com/espressif/esp-now) | 661 | 113 | A connectionless Wi-Fi communication protocol |
...
| [esp-dsp](https://github.com/espressif/esp-dsp) | 584 | 103 | DSP library for ESP-IDF |
| [esp-rainmaker](https://github.com/espressif/esp-rainmaker) | 551 | 187 | ESP RainMaker Agent for firmware development |
| [esp-tflite-micro](https://github.com/espressif/esp-tflite-micro) | 526 | 121 | TensorFlow Lite Micro for Espressif Chipsets |
| [esp-dev-kits](https://github.com/espressif/esp-dev-kits) | 506 | 207 | Docs, Schematics, Factory Firmwares for ESP Development Kits |
| [rust-esp32-example](https://github.com/espressif/rust-esp32-example) | 487 | 39 | Example of Rust integration into an ESP-IDF project, for ESP32 series of chips |
| [esp-serial-flasher](https://github.com/espressif/esp-serial-flasher) | 480 | 132 | Library for flashing Espressif SoCs from other MCUs. |
...
| [esp-brookesia](https://github.com/espressif/esp-brookesia) | 405 | 86 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
| [esptool-js](https://github.com/espressif/esptool-js) | 396 | 136 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
| [esp-idf-template](https://github.com/espressif/esp-idf-template) | 350 | 207 | Template application for https://github.com/espressif/esp-idf |
| [esp-aliyun](https://github.com/espressif/esp-aliyun) | 349 | 148 | Aliyun Iotkit-embedded, support esp32 & esp8266. |
| [esp-usb-bridge](https://github.com/espressif/esp-usb-bridge) | 349 | 38 | USB to UART&JTAG bridge, implemented on ESP32-S2 or ESP32-S3 |
...
| [esp-bsp](https://github.com/espressif/esp-bsp) | 322 | 164 | Board support components for Espressif development boards |
| [esp-aws-iot](https://github.com/espressif/esp-aws-iot) | 304 | 183 | AWS IoT SDK for ESP32 based chipsets |
| [esp-va-sdk](https://github.com/espressif/esp-va-sdk) | 302 | 86 | Espressif's Voice Assistant SDK: Alexa, Google Voice Assistant, Google DialogFlow |
| [esp-zigbee-sdk](https://github.com/espressif/esp-zigbee-sdk) | 299 | 59 | Espressif Zigbee SDK |
| [esp-webrtc-solution](https://github.com/espressif/esp-webrtc-solution) | 257 | 43 | None |
...
| [esp32-doom](https://github.com/espressif/esp32-doom) | 244 | 48 | A proof-of-concept port of PrBoom to the ESP32. Needs psram hardware. |
| [esp-idf-provisioning-android](https://github.com/espressif/esp-idf-provisioning-android) | 240 | 155 | Android Provisioning application for ESP-IDF Unified provisioning |
| [esp-iot-bridge](https://github.com/espressif/esp-iot-bridge) | 201 | 66 | A smart bridge to make both ESP and the other MCU or smart device can access the Internet. |
...
| [esp-jumpstart](https://github.com/espressif/esp-jumpstart) | 194 | 60 | Jumpstart from concept to production |
...
| [esp-nn](https://github.com/espressif/esp-nn) | 187 | 32 | Optimised Neural Network functions for Espressif chipsets |
| [esp-azure](https://github.com/espressif/esp-azure) | 185 | 95 | SDK to connect ESP8266 and ESP32 to Microsoft Azure IoT services |
| [esp32-arduino-lib-builder](https://github.com/espressif/esp32-arduino-lib-builder) | 184 | 183 | None |
| [esp32-wifi-lib](https://github.com/espressif/esp32-wifi-lib) | 184 | 74 | ESP32 WiFi stack precompiled libraries |
| [esp-mesh-lite](https://github.com/espressif/esp-mesh-lite) | 178 | 36 | A lite version Wi-Fi Mesh, each node can access the network over the IP layer. |
...
| [esp-modbus](https://github.com/espressif/esp-modbus) | 156 | 67 | ESP-Modbus - the officially suppported library for Modbus protocol (serial RS485 + TCP over WiFi or Ethernet). |
...
| [esp-wasmachine](https://github.com/espressif/esp-wasmachine) | 107 | 8 | The Machine which can run WASM applications. |
...
| [esp-adf-libs](https://github.com/espressif/esp-adf-libs) | 86 | 51 | None |
...
| [openocd-on-esp32](https://github.com/espressif/openocd-on-esp32) | 81 | 8 | OpenOCD port running on ESP32-S3 microcontrollers |
...
| [esp-gmf](https://github.com/espressif/esp-gmf) | 62 | 15 | Espressif General Multimedia Framework (ESP-GMF) |
...
| [esp-hosted-mcu](https://github.com/espressif/esp-hosted-mcu) | 50 | 14 | None |
...
| [esp-video-components](https://github.com/espressif/esp-video-components) | 29 | 10 | Collections of components to be used for camera related functionalities. |
...
| [esp-wifi-remote](https://github.com/espressif/esp-wifi-remote) | 12 | 2 | Allows WiFi-enabled ESP capabilities on remote targets (without native WiFi) using designated transports |
...
| [esp-boost](https://github.com/espressif/esp-boost) | 11 | 3 | Boost C++ libraries for ESP Series SoCs (ESP32, ESP32-S3, ESP32-P4, etc.) |
