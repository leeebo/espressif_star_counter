# Espressif Systems Github Star Rank 2025-04-25

## Total Star 🌟: 75729, Total Fork 🌳: 30819
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 15055 | 7609 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 14683 | 7600 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5833 | 1420 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
| [ESP8266_RTOS_SDK](https://github.com/espressif/ESP8266_RTOS_SDK) | 3423 | 1584 | Latest ESP8266 SDK based on FreeRTOS, esp-idf style. |
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2189 | 843 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 2176 | 686 | None |
| [esp-adf](https://github.com/espressif/esp-adf) | 1861 | 757 | Espressif Audio Development Framework |
| [esp-who](https://github.com/espressif/esp-who) | 1813 | 483 | Face detection and recognition framework |
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1196 | 319 | Visual Studio Code extension for ESP-IDF projects |
| [esp-drone](https://github.com/espressif/esp-drone) | 1063 | 276 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-at](https://github.com/espressif/esp-at) | 993 | 947 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [esp-box](https://github.com/espressif/esp-box) | 975 | 221 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
| [ESP8266_NONOS_SDK](https://github.com/espressif/ESP8266_NONOS_SDK) | 951 | 542 | ESP8266 nonOS SDK |
| [esp-sr](https://github.com/espressif/esp-sr) | 893 | 137 | Speech recognition |
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 879 | 118 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
| [esp-matter](https://github.com/espressif/esp-matter) | 814 | 183 | Espressif's SDK for Matter |
| [esp-mdf](https://github.com/espressif/esp-mdf) | 804 | 254 | Espressif Mesh Development Framework, limited maintain, recommend to use https://github.com/espressif/esp-mesh-lite |
| [esp-hosted](https://github.com/espressif/esp-hosted) | 790 | 186 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
| [esp-csi](https://github.com/espressif/esp-csi) | 778 | 118 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
...
| [esp-dl](https://github.com/espressif/esp-dl) | 688 | 139 | Espressif deep-learning library for AIoT applications |
| [esp-skainet](https://github.com/espressif/esp-skainet) | 687 | 155 | Espressif intelligent voice assistant |
| [esp-mqtt](https://github.com/espressif/esp-mqtt) | 644 | 262 | ESP32 mqtt component |
...
| [esp-now](https://github.com/espressif/esp-now) | 600 | 108 | A connectionless Wi-Fi communication protocol |
| [esp32-nesemu](https://github.com/espressif/esp32-nesemu) | 570 | 175 | Proof-of-concept NES emulator for the ESP32 |
| [esp-dsp](https://github.com/espressif/esp-dsp) | 543 | 97 | DSP library for ESP-IDF |
| [esp-rainmaker](https://github.com/espressif/esp-rainmaker) | 510 | 169 | ESP RainMaker Agent for firmware development |
| [rust-esp32-example](https://github.com/espressif/rust-esp32-example) | 473 | 39 | Example of Rust integration into an ESP-IDF project, for ESP32 series of chips |
...
| [esp-tflite-micro](https://github.com/espressif/esp-tflite-micro) | 467 | 101 | TensorFlow Lite Micro for Espressif Chipsets |
| [esp-serial-flasher](https://github.com/espressif/esp-serial-flasher) | 441 | 124 | Library for flashing Espressif SoCs from other MCUs. |
| [esp-dev-kits](https://github.com/espressif/esp-dev-kits) | 429 | 192 | Docs, Schematics, Factory Firmwares for ESP Development Kits |
| [openocd-esp32](https://github.com/espressif/openocd-esp32) | 391 | 143 | OpenOCD branch with ESP32 JTAG support |
...
| [esptool-js](https://github.com/espressif/esptool-js) | 343 | 117 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
...
| [esp-usb-bridge](https://github.com/espressif/esp-usb-bridge) | 324 | 36 | USB to UART&JTAG bridge, implemented on ESP32-S2 or ESP32-S3 |
...
| [esp-aws-iot](https://github.com/espressif/esp-aws-iot) | 288 | 174 | AWS IoT SDK for ESP32 based chipsets |
| [esp-bsp](https://github.com/espressif/esp-bsp) | 258 | 142 | Board support components for Espressif development boards |
| [esp-zigbee-sdk](https://github.com/espressif/esp-zigbee-sdk) | 253 | 45 | Espressif Zigbee SDK |
| [esp-protocols](https://github.com/espressif/esp-protocols) | 226 | 156 | Collection of ESP-IDF components related to networking protocols |
...
| [esp32-doom](https://github.com/espressif/esp32-doom) | 219 | 44 | A proof-of-concept port of PrBoom to the ESP32. Needs psram hardware. |
...
| [esp-iot-bridge](https://github.com/espressif/esp-iot-bridge) | 185 | 60 | A smart bridge to make both ESP and the other MCU or smart device can access the Internet. |
...
| [esp-mesh-lite](https://github.com/espressif/esp-mesh-lite) | 160 | 30 | A lite version Wi-Fi Mesh, each node can access the network over the IP layer. |
...
| [esp-thread-br](https://github.com/espressif/esp-thread-br) | 140 | 35 | Espressif Thread Border Router SDK |
...
| [esp-insights](https://github.com/espressif/esp-insights) | 121 | 35 | ESP Insights: A remote diagnostics/observability framework for connected devices |
| [esp-webrtc-solution](https://github.com/espressif/esp-webrtc-solution) | 119 | 15 | None |
...
| [pytest-embedded](https://github.com/espressif/pytest-embedded) | 104 | 28 | A pytest plugin that designed for embedded testing |
...
| [esp-adf-libs](https://github.com/espressif/esp-adf-libs) | 75 | 47 | None |
...
| [esp-launchpad](https://github.com/espressif/esp-launchpad) | 58 | 24 | Configurable Browser-based Image Flasher |
...
| [esp-eth-drivers](https://github.com/espressif/esp-eth-drivers) | 37 | 17 | Collection of additional Ethernet drivers for ESP-IDF |
...
| [esp-cryptoauthlib](https://github.com/espressif/esp-cryptoauthlib) | 31 | 34 | Release only fork of https://github.com/MicrochipTech/cryptoauthlib |
...
| [esp-gmf](https://github.com/espressif/esp-gmf) | 15 | 3 | Espressif General Multimedia Framework (ESP-GMF) |
...
| [esp-amp](https://github.com/espressif/esp-amp) | 10 | 0 | ESP AMP |
...
| [release-zips-action](https://github.com/espressif/release-zips-action) | 0 | 0 | Migrated release_zips action from espressif/github-actions (preserve git history) |
