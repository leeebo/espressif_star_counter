# Espressif Systems Github Star Rank 2025-03-23

## Total Star 🌟: 74265, Total Fork 🌳: 30484
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 14795 | 7543 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 14498 | 7561 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5783 | 1414 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
| [ESP8266_RTOS_SDK](https://github.com/espressif/ESP8266_RTOS_SDK) | 3403 | 1580 | Latest ESP8266 SDK based on FreeRTOS, esp-idf style. |
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2143 | 831 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 2117 | 670 | None |
| [esp-adf](https://github.com/espressif/esp-adf) | 1810 | 745 | Espressif Audio Development Framework |
| [esp-who](https://github.com/espressif/esp-who) | 1792 | 480 | Face detection and recognition framework |
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1168 | 320 | Visual Studio Code extension for ESP-IDF projects |
| [esp-drone](https://github.com/espressif/esp-drone) | 985 | 268 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-at](https://github.com/espressif/esp-at) | 973 | 917 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [ESP8266_NONOS_SDK](https://github.com/espressif/ESP8266_NONOS_SDK) | 945 | 542 | ESP8266 nonOS SDK |
| [esp-box](https://github.com/espressif/esp-box) | 940 | 221 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 852 | 117 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
| [esp-sr](https://github.com/espressif/esp-sr) | 809 | 128 | Speech recognition |
...
| [esp-matter](https://github.com/espressif/esp-matter) | 790 | 177 | Espressif's SDK for Matter |
| [esp-hosted](https://github.com/espressif/esp-hosted) | 772 | 183 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
| [esp-csi](https://github.com/espressif/esp-csi) | 764 | 114 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
...
| [esp-skainet](https://github.com/espressif/esp-skainet) | 666 | 153 | Espressif intelligent voice assistant |
| [esp-dl](https://github.com/espressif/esp-dl) | 661 | 136 | Espressif deep-learning library for AIoT applications |
...
| [esp-homekit-sdk](https://github.com/espressif/esp-homekit-sdk) | 602 | 114 | None |
| [esp-now](https://github.com/espressif/esp-now) | 585 | 102 | A connectionless Wi-Fi communication protocol |
| [esp32-nesemu](https://github.com/espressif/esp32-nesemu) | 563 | 173 | Proof-of-concept NES emulator for the ESP32 |
| [esp-dsp](https://github.com/espressif/esp-dsp) | 519 | 96 | DSP library for ESP-IDF |
| [esp-rainmaker](https://github.com/espressif/esp-rainmaker) | 499 | 165 | ESP RainMaker Agent for firmware development |
...
| [rust-esp32-example](https://github.com/espressif/rust-esp32-example) | 467 | 37 | Example of Rust integration into an ESP-IDF project, for ESP32 series of chips |
| [esp-tflite-micro](https://github.com/espressif/esp-tflite-micro) | 454 | 99 | TensorFlow Lite Micro for Espressif Chipsets |
| [esp-serial-flasher](https://github.com/espressif/esp-serial-flasher) | 431 | 122 | Library for flashing Espressif SoCs from other MCUs. |
| [esp-dev-kits](https://github.com/espressif/esp-dev-kits) | 413 | 189 | Docs, Schematics, Factory Firmwares for ESP Development Kits |
| [openocd-esp32](https://github.com/espressif/openocd-esp32) | 383 | 138 | OpenOCD branch with ESP32 JTAG support |
...
| [esptool-js](https://github.com/espressif/esptool-js) | 335 | 117 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
...
| [esp-aws-iot](https://github.com/espressif/esp-aws-iot) | 287 | 173 | AWS IoT SDK for ESP32 based chipsets |
| [esp-bsp](https://github.com/espressif/esp-bsp) | 242 | 136 | Board support components for Espressif development boards |
| [esp-zigbee-sdk](https://github.com/espressif/esp-zigbee-sdk) | 236 | 45 | Espressif Zigbee SDK |
| [esp-protocols](https://github.com/espressif/esp-protocols) | 220 | 152 | Collection of ESP-IDF components related to networking protocols |
...
| [esp-iot-bridge](https://github.com/espressif/esp-iot-bridge) | 182 | 60 | A smart bridge to make both ESP and the other MCU or smart device can access the Internet. |
...
| [esp-nn](https://github.com/espressif/esp-nn) | 163 | 26 | Optimised Neural Network functions for Espressif chipsets |
...
| [esp-modbus](https://github.com/espressif/esp-modbus) | 138 | 57 | ESP-Modbus - the officially suppported library for Modbus protocol (serial RS485 + TCP over WiFi or Ethernet). |
...
| [book-esp32c3-iot-projects](https://github.com/espressif/book-esp32c3-iot-projects) | 120 | 38 | 《ESP32-C3 物联网工程开发实战》配套代码 |
...
| [usb-pids](https://github.com/espressif/usb-pids) | 96 | 151 | Customer-allocated USB PIDs under the Espressif VID |
| [esp-webrtc-solution](https://github.com/espressif/esp-webrtc-solution) | 92 | 11 | None |
| [esp-wasmachine](https://github.com/espressif/esp-wasmachine) | 90 | 8 | The Machine which can run WASM applications. |
| [esp-idf-cxx](https://github.com/espressif/esp-idf-cxx) | 86 | 18 | C++ wrapper classes for ESP-IDF components. |
...
| [esp-launchpad](https://github.com/espressif/esp-launchpad) | 55 | 21 | Configurable Browser-based Image Flasher |
...
| [esp-h264-component](https://github.com/espressif/esp-h264-component) | 28 | 0 | H264 encoder/decoder of espressif |
...
| [esp-video-components](https://github.com/espressif/esp-video-components) | 15 | 2 | Collections of components to be used for camera related functionalities. |
...
| [developer-portal](https://github.com/espressif/developer-portal) | 13 | 37 | Developer Portal |
...
| [esp-lowcode-matter](https://github.com/espressif/esp-lowcode-matter) | 12 | 6 | ESP LowCode: For Building Matter-enabled connected products |
...
| [esp-opencv-component](https://github.com/espressif/esp-opencv-component) | 0 | 1 | OpenCV library as an ESP-IDF component |
