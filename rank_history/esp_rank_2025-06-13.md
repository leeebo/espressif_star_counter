# Espressif Systems Github Star Rank 2025-06-13

## Total Star 🌟: 77720, Total Fork 🌳: 31257
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 15433 | 7699 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 14904 | 7635 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5910 | 1431 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
| [ESP8266_RTOS_SDK](https://github.com/espressif/ESP8266_RTOS_SDK) | 3441 | 1586 | Latest ESP8266 SDK based on FreeRTOS, esp-idf style. |
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2255 | 861 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 2241 | 697 | None |
| [esp-adf](https://github.com/espressif/esp-adf) | 1927 | 770 | Espressif Advanced Development Framework |
| [esp-who](https://github.com/espressif/esp-who) | 1851 | 490 | Face detection and recognition framework |
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1241 | 328 | Visual Studio Code extension for ESP-IDF projects |
| [esp-drone](https://github.com/espressif/esp-drone) | 1116 | 293 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-at](https://github.com/espressif/esp-at) | 1021 | 982 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [esp-box](https://github.com/espressif/esp-box) | 1015 | 228 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
| [esp-sr](https://github.com/espressif/esp-sr) | 963 | 144 | Speech recognition |
| [ESP8266_NONOS_SDK](https://github.com/espressif/ESP8266_NONOS_SDK) | 959 | 542 | ESP8266 nonOS SDK |
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 910 | 125 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
| [esp-matter](https://github.com/espressif/esp-matter) | 838 | 192 | Espressif's SDK for Matter |
| [esp-hosted](https://github.com/espressif/esp-hosted) | 816 | 190 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
...
| [esp-csi](https://github.com/espressif/esp-csi) | 794 | 118 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
...
| [esp-dl](https://github.com/espressif/esp-dl) | 723 | 142 | Espressif deep-learning library for AIoT applications |
| [esp-skainet](https://github.com/espressif/esp-skainet) | 718 | 161 | Espressif intelligent voice assistant |
| [esp-mqtt](https://github.com/espressif/esp-mqtt) | 655 | 266 | ESP32 mqtt component |
...
| [esp-now](https://github.com/espressif/esp-now) | 619 | 108 | A connectionless Wi-Fi communication protocol |
...
| [esp-dsp](https://github.com/espressif/esp-dsp) | 558 | 99 | DSP library for ESP-IDF |
| [esp-rainmaker](https://github.com/espressif/esp-rainmaker) | 526 | 179 | ESP RainMaker Agent for firmware development |
| [esp-tflite-micro](https://github.com/espressif/esp-tflite-micro) | 488 | 106 | TensorFlow Lite Micro for Espressif Chipsets |
...
| [esptool-js](https://github.com/espressif/esptool-js) | 360 | 126 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
...
| [idf-eclipse-plugin](https://github.com/espressif/idf-eclipse-plugin) | 340 | 129 | Espressif-IDE (ESP-IDF Eclipse Plugin) for ESP-IDF CMake based projects 5.x and above |
...
| [esp-bsp](https://github.com/espressif/esp-bsp) | 287 | 147 | Board support components for Espressif development boards |
...
| [esp32-doom](https://github.com/espressif/esp32-doom) | 227 | 47 | A proof-of-concept port of PrBoom to the ESP32. Needs psram hardware. |
...
| [esp-brookesia](https://github.com/espressif/esp-brookesia) | 132 | 15 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
...
| [esp-rainmaker-android](https://github.com/espressif/esp-rainmaker-android) | 122 | 64 | ESP RainMaker Android app sources |
...
| [openocd-on-esp32](https://github.com/espressif/openocd-on-esp32) | 75 | 7 | OpenOCD port running on ESP32-S3 microcontrollers |
...
| [esp-lowcode-matter](https://github.com/espressif/esp-lowcode-matter) | 37 | 16 | ESP LowCode: For Building Matter-enabled connected products |
...
| [esp-gmf](https://github.com/espressif/esp-gmf) | 23 | 6 | Espressif General Multimedia Framework (ESP-GMF) |
...
| [esp-detection](https://github.com/espressif/esp-detection) | 18 | 1 | Lightweight real-time object detection on ESP series chips, based on Ultralytics YOLOv11 |
