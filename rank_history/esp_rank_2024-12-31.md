# Espressif Systems Github Star Rank 2024-12-31

## Total Star 🌟: 70671, Total Fork 🌳: 29582
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 14111 | 7376 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 13962 | 7476 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5663 | 1392 | Espressif SoC serial bootloader utility |
| [ESP8266_RTOS_SDK](https://github.com/espressif/ESP8266_RTOS_SDK) | 3369 | 1567 | Latest ESP8266 SDK based on FreeRTOS, esp-idf style. |
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2026 | 798 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 1991 | 650 | None |
| [esp-who](https://github.com/espressif/esp-who) | 1736 | 468 | Face detection and recognition framework |
| [esp-adf](https://github.com/espressif/esp-adf) | 1598 | 700 | Espressif Audio Development Framework |
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1103 | 312 | Visual Studio Code extension for ESP-IDF projects |
| [ESP8266_NONOS_SDK](https://github.com/espressif/ESP8266_NONOS_SDK) | 934 | 536 | ESP8266 nonOS SDK |
| [esp-at](https://github.com/espressif/esp-at) | 932 | 849 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [esp-drone](https://github.com/espressif/esp-drone) | 892 | 249 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-box](https://github.com/espressif/esp-box) | 848 | 197 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 801 | 112 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
| [esp-mdf](https://github.com/espressif/esp-mdf) | 786 | 253 | Espressif Mesh Development Framework, limited maintain, recommend to use https://github.com/espressif/esp-mesh-lite |
| [ESP8266_MP3_DECODER](https://github.com/espressif/ESP8266_MP3_DECODER) | 747 | 190 | A demo that should be run with ESP8266 Non-OS SDK |
| [esp-csi](https://github.com/espressif/esp-csi) | 737 | 110 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
| [esp-matter](https://github.com/espressif/esp-matter) | 732 | 166 | Espressif's SDK for Matter |
| [esp-hosted](https://github.com/espressif/esp-hosted) | 729 | 170 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
| [esp-apple-homekit-adk](https://github.com/espressif/esp-apple-homekit-adk) | 629 | 65 | This is a port for Apple's Open Source HomeKit ADK |
| [esp-mqtt](https://github.com/espressif/esp-mqtt) | 621 | 258 | ESP32 mqtt component |
| [esp-sr](https://github.com/espressif/esp-sr) | 613 | 108 | Speech recognition |
| [esp-skainet](https://github.com/espressif/esp-skainet) | 606 | 136 | Espressif intelligent voice assistant |
| [esp-dl](https://github.com/espressif/esp-dl) | 595 | 126 | Espressif deep-learning library for AIoT applications |
| [esp-homekit-sdk](https://github.com/espressif/esp-homekit-sdk) | 582 | 110 | None |
| [esp-now](https://github.com/espressif/esp-now) | 562 | 97 | A connectionless Wi-Fi communication protocol |
...
| [esp-rainmaker](https://github.com/espressif/esp-rainmaker) | 475 | 157 | ESP RainMaker Agent for firmware development |
...
| [esp-tflite-micro](https://github.com/espressif/esp-tflite-micro) | 410 | 88 | TensorFlow Lite Micro for Espressif Chipsets |
| [esp-serial-flasher](https://github.com/espressif/esp-serial-flasher) | 400 | 117 | Library for flashing Espressif SoCs from other MCUs. |
| [esp-dev-kits](https://github.com/espressif/esp-dev-kits) | 381 | 187 | Docs, Schematics, Factory Firmwares for ESP Development Kits |
...
| [idf-eclipse-plugin](https://github.com/espressif/idf-eclipse-plugin) | 322 | 122 | Espressif-IDE (ESP-IDF Eclipse Plugin) for ESP-IDF CMake based projects 5.x and above |
| [esp-usb-bridge](https://github.com/espressif/esp-usb-bridge) | 307 | 34 | USB to UART&JTAG bridge, implemented on ESP32-S2 or ESP32-S3 |
| [esptool-js](https://github.com/espressif/esptool-js) | 306 | 111 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
| [esp-va-sdk](https://github.com/espressif/esp-va-sdk) | 297 | 83 | Espressif's Voice Assistant SDK: Alexa, Google Voice Assistant, Google DialogFlow |
| [esp-aws-iot](https://github.com/espressif/esp-aws-iot) | 275 | 166 | AWS IoT SDK for ESP32 based chipsets |
| [esp-bsp](https://github.com/espressif/esp-bsp) | 218 | 115 | Board support components for Espressif development boards |
...
| [esp-protocols](https://github.com/espressif/esp-protocols) | 204 | 137 | Collection of ESP-IDF components related to networking protocols |
...
| [esp-zigbee-sdk](https://github.com/espressif/esp-zigbee-sdk) | 192 | 35 | Espressif Zigbee SDK |
...
| [esp-iot-bridge](https://github.com/espressif/esp-iot-bridge) | 176 | 54 | A smart bridge to make both ESP and the other MCU or smart device can access the Internet. |
| [esp32-wifi-lib](https://github.com/espressif/esp32-wifi-lib) | 167 | 72 | ESP32 WiFi stack precompiled libraries |
| [idf-extra-components](https://github.com/espressif/idf-extra-components) | 164 | 93 | Additional components for ESP-IDF, maintained by Espressif |
...
| [esp-mesh-lite](https://github.com/espressif/esp-mesh-lite) | 139 | 25 | A lite version Wi-Fi Mesh, each node can access the network over the IP layer. |
| [esp8266-rtos-sample-code](https://github.com/espressif/esp8266-rtos-sample-code) | 129 | 86 | None |
| [esp-modbus](https://github.com/espressif/esp-modbus) | 123 | 55 | ESP-Modbus - the officially suppported library for Modbus protocol (serial RS485 + TCP over WiFi or Ethernet). |
| [esp-thread-br](https://github.com/espressif/esp-thread-br) | 122 | 26 | Espressif Thread Border Router SDK |
| [book-esp32c3-iot-projects](https://github.com/espressif/book-esp32c3-iot-projects) | 112 | 35 | 《ESP32-C3 物联网工程开发实战》配套代码 |
...
| [esp-lwip](https://github.com/espressif/esp-lwip) | 92 | 131 | Fork of lwIP (https://savannah.nongnu.org/projects/lwip/) with ESP-IDF specific patches |
| [usb-pids](https://github.com/espressif/usb-pids) | 92 | 140 | Customer-allocated USB PIDs under the Espressif VID |
| [esp-wasmachine](https://github.com/espressif/esp-wasmachine) | 86 | 6 | The Machine which can run WASM applications. |
...
| [esp-adf-libs](https://github.com/espressif/esp-adf-libs) | 65 | 43 | None |
...
| [esp-usb](https://github.com/espressif/esp-usb) | 31 | 19 | None |
...
| [esp-debug-adapter](https://github.com/espressif/esp-debug-adapter) | 25 | 14 | An implementation of Microsoft Debug Adapter Protocol server which works with GDB. |
...
| [esp-hal-3rdparty](https://github.com/espressif/esp-hal-3rdparty) | 19 | 20 | None |
...
| [esp32-arduino-libs](https://github.com/espressif/esp32-arduino-libs) | 13 | 15 | Holding precompiled ESP-IDF libraries for ESP32 Arduino v3.x and above |
...
| [.github](https://github.com/espressif/.github) | 6 | 5 | None |
...
| [esp-idf-nvs-partition-gen](https://github.com/espressif/esp-idf-nvs-partition-gen) | 5 | 3 | NVS Partition Generator tool |
...
| [esp-hosted-mcu](https://github.com/espressif/esp-hosted-mcu) | 1 | 1 | None |
...
| [esp-bool-parser](https://github.com/espressif/esp-bool-parser) | 0 | 0 | A lightweight tool for parsing boolean expressions with support for diverse operand types, including SOC capabilities, environment variables, strings, booleans, and integers. |
