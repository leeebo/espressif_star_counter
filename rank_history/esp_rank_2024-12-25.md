# Espressif Systems Github Star Rank 2024-12-25

## Total Star 🌟: 70407, Total Fork 🌳: 29536
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 14066 | 7368 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 13912 | 7467 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5653 | 1391 | Espressif SoC serial bootloader utility |
| [ESP8266_RTOS_SDK](https://github.com/espressif/ESP8266_RTOS_SDK) | 3366 | 1567 | Latest ESP8266 SDK based on FreeRTOS, esp-idf style. |
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2017 | 797 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 1981 | 650 | None |
| [esp-who](https://github.com/espressif/esp-who) | 1732 | 469 | Face detection and recognition framework |
| [esp-adf](https://github.com/espressif/esp-adf) | 1586 | 698 | Espressif Audio Development Framework |
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1099 | 310 | Visual Studio Code extension for ESP-IDF projects |
| [ESP8266_NONOS_SDK](https://github.com/espressif/ESP8266_NONOS_SDK) | 935 | 536 | ESP8266 nonOS SDK |
| [esp-at](https://github.com/espressif/esp-at) | 932 | 846 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [esp-drone](https://github.com/espressif/esp-drone) | 884 | 247 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-box](https://github.com/espressif/esp-box) | 838 | 194 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 795 | 111 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
...
| [esp-csi](https://github.com/espressif/esp-csi) | 733 | 110 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
| [esp-matter](https://github.com/espressif/esp-matter) | 725 | 165 | Espressif's SDK for Matter |
| [esp-hosted](https://github.com/espressif/esp-hosted) | 724 | 171 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
...
| [esp-mqtt](https://github.com/espressif/esp-mqtt) | 619 | 258 | ESP32 mqtt component |
| [esp-sr](https://github.com/espressif/esp-sr) | 610 | 108 | Speech recognition |
| [esp-skainet](https://github.com/espressif/esp-skainet) | 601 | 136 | Espressif intelligent voice assistant |
| [esp-dl](https://github.com/espressif/esp-dl) | 593 | 126 | Espressif deep-learning library for AIoT applications |
| [esp-homekit-sdk](https://github.com/espressif/esp-homekit-sdk) | 579 | 109 | None |
| [esp-now](https://github.com/espressif/esp-now) | 560 | 98 | A connectionless Wi-Fi communication protocol |
| [esp32-nesemu](https://github.com/espressif/esp32-nesemu) | 552 | 173 | Proof-of-concept NES emulator for the ESP32 |
| [esp-dsp](https://github.com/espressif/esp-dsp) | 495 | 92 | DSP library for ESP-IDF |
| [esp-rainmaker](https://github.com/espressif/esp-rainmaker) | 473 | 157 | ESP RainMaker Agent for firmware development |
...
| [rust-esp32-example](https://github.com/espressif/rust-esp32-example) | 451 | 36 | Example of Rust integration into an ESP-IDF project, for ESP32 series of chips |
| [esp-tflite-micro](https://github.com/espressif/esp-tflite-micro) | 406 | 88 | TensorFlow Lite Micro for Espressif Chipsets |
| [esp-serial-flasher](https://github.com/espressif/esp-serial-flasher) | 398 | 116 | Library for flashing Espressif SoCs from other MCUs. |
| [esp-dev-kits](https://github.com/espressif/esp-dev-kits) | 378 | 186 | Docs, Schematics, Factory Firmwares for ESP Development Kits |
| [openocd-esp32](https://github.com/espressif/openocd-esp32) | 366 | 134 | OpenOCD branch with ESP32 JTAG support |
...
| [idf-eclipse-plugin](https://github.com/espressif/idf-eclipse-plugin) | 321 | 122 | Espressif-IDE (ESP-IDF Eclipse Plugin) for ESP-IDF CMake based projects 5.x and above |
| [esp-usb-bridge](https://github.com/espressif/esp-usb-bridge) | 306 | 34 | USB to UART&JTAG bridge, implemented on ESP32-S2 or ESP32-S3 |
| [esptool-js](https://github.com/espressif/esptool-js) | 301 | 111 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
...
| [esp-bsp](https://github.com/espressif/esp-bsp) | 215 | 114 | Board support components for Espressif development boards |
| [esp-idf-provisioning-android](https://github.com/espressif/esp-idf-provisioning-android) | 208 | 138 | Android Provisioning application for ESP-IDF Unified provisioning |
| [esp-protocols](https://github.com/espressif/esp-protocols) | 203 | 136 | Collection of ESP-IDF components related to networking protocols |
| [esp32-doom](https://github.com/espressif/esp32-doom) | 202 | 39 | A proof-of-concept port of PrBoom to the ESP32. Needs psram hardware. |
...
| [esp-zigbee-sdk](https://github.com/espressif/esp-zigbee-sdk) | 187 | 34 | Espressif Zigbee SDK |
| [esp-jumpstart](https://github.com/espressif/esp-jumpstart) | 180 | 58 | Jumpstart from concept to production |
| [esp-azure](https://github.com/espressif/esp-azure) | 178 | 93 | SDK to connect ESP8266 and ESP32 to Microsoft Azure IoT services |
| [esp-iot-bridge](https://github.com/espressif/esp-iot-bridge) | 173 | 54 | A smart bridge to make both ESP and the other MCU or smart device can access the Internet. |
| [esp32-wifi-lib](https://github.com/espressif/esp32-wifi-lib) | 167 | 72 | ESP32 WiFi stack precompiled libraries |
| [esp-gdbstub](https://github.com/espressif/esp-gdbstub) | 163 | 38 | None |
| [idf-extra-components](https://github.com/espressif/idf-extra-components) | 159 | 93 | Additional components for ESP-IDF, maintained by Espressif |
| [esp32-arduino-lib-builder](https://github.com/espressif/esp32-arduino-lib-builder) | 155 | 173 | None |
| [esp-nn](https://github.com/espressif/esp-nn) | 149 | 24 | Optimised Neural Network functions for Espressif chipsets |
...
| [esp-modbus](https://github.com/espressif/esp-modbus) | 122 | 55 | ESP-Modbus - the officially suppported library for Modbus protocol (serial RS485 + TCP over WiFi or Ethernet). |
| [esp-thread-br](https://github.com/espressif/esp-thread-br) | 121 | 26 | Espressif Thread Border Router SDK |
| [book-esp32c3-iot-projects](https://github.com/espressif/book-esp32c3-iot-projects) | 111 | 35 | 《ESP32-C3 物联网工程开发实战》配套代码 |
| [esp-insights](https://github.com/espressif/esp-insights) | 107 | 29 | ESP Insights: A remote diagnostics/observability framework for connected devices |
...
| [esp-lwip](https://github.com/espressif/esp-lwip) | 90 | 130 | Fork of lwIP (https://savannah.nongnu.org/projects/lwip/) with ESP-IDF specific patches |
| [esp-wasmachine](https://github.com/espressif/esp-wasmachine) | 84 | 6 | The Machine which can run WASM applications. |
...
| [esp32c3-direct-boot-example](https://github.com/espressif/esp32c3-direct-boot-example) | 70 | 18 | Example of ESP32-C3 (rev. 3 and later) "direct boot" feature. |
| [esp8266-nonos-sample-code](https://github.com/espressif/esp8266-nonos-sample-code) | 66 | 41 | None |
| [esp-brookesia](https://github.com/espressif/esp-brookesia) | 64 | 10 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
...
| [idf-component-manager](https://github.com/espressif/idf-component-manager) | 49 | 17 | Tool for installing ESP-IDF components |
...
| [esp-launchpad](https://github.com/espressif/esp-launchpad) | 46 | 15 | Configurable Browser-based Image Flasher |
...
| [esp-eth-drivers](https://github.com/espressif/esp-eth-drivers) | 31 | 16 | Collection of additional Ethernet drivers for ESP-IDF |
...
| [esp-idf-monitor](https://github.com/espressif/esp-idf-monitor) | 24 | 9 | None |
...
| [esp-h264-component](https://github.com/espressif/esp-h264-component) | 22 | 0 | H264 encoder/decoder of espressif |
...
| [esp-hal-components](https://github.com/espressif/esp-hal-components) | 15 | 6 | HAL (hardware abstraction layer) components for Espressif chips |
...
| [esp-freertos-coremqtt](https://github.com/espressif/esp-freertos-coremqtt) | 13 | 5 | None |
...
| [midi-workshop](https://github.com/espressif/midi-workshop) | 7 | 1 | Repository with materials for ESP32-S3 USB MIDI workshop in Brno on 2024/05/17 |
...
| [esp-rainmaker-webhooks](https://github.com/espressif/esp-rainmaker-webhooks) | 5 | 2 | Rainmaker Web hooks Project |
