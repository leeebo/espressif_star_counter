# Espressif Systems Github Star Rank 2024-09-20

## Total Star 🌟: 66933, Total Fork 🌳: 28734

[![Update Espressif Systems Github Star Rank](https://github.com/leeebo/espressif_star_counter/actions/workflows/update_rank.yml/badge.svg)](https://github.com/leeebo/espressif_star_counter/actions/workflows/update_rank.yml)

| Repository | Stars | Forks | Description |
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 13366 | 7213 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 13342 | 7365 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5492 | 1367 | Espressif SoC serial bootloader utility |
...
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 1886 | 758 | Espressif IoT Library. IoT Device Drivers, Documentations And Solutions. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 1852 | 634 | None |
| [esp-who](https://github.com/espressif/esp-who) | 1668 | 465 | Face detection and recognition framework |
...
| [esp-at](https://github.com/espressif/esp-at) | 871 | 775 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [esp-drone](https://github.com/espressif/esp-drone) | 777 | 230 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
...
| [esp-csi](https://github.com/espressif/esp-csi) | 683 | 106 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
...
| [esp-dl](https://github.com/espressif/esp-dl) | 546 | 118 | Espressif deep-learning library for AIoT applications |
...
| [esp-serial-flasher](https://github.com/espressif/esp-serial-flasher) | 364 | 108 | Library for flashing Espressif SoCs from other MCUs. |
...
| [idf-eclipse-plugin](https://github.com/espressif/idf-eclipse-plugin) | 301 | 120 | Espressif-IDE (based on Eclipse CDT) for ESP-IDF CMake based projects 4.x and above |
...
| [esp-bsp](https://github.com/espressif/esp-bsp) | 183 | 96 | Board support components for Espressif development boards |
...
| [esp-mesh-lite](https://github.com/espressif/esp-mesh-lite) | 123 | 18 | A lite version Wi-Fi Mesh, each node can access the network over the IP layer. |
...
| [esp-lwip](https://github.com/espressif/esp-lwip) | 84 | 128 | Fork of lwIP (https://savannah.nongnu.org/projects/lwip/) with ESP-IDF specific patches |
