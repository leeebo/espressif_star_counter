# Espressif Systems Github Star Rank 2025-05-13

## Total Star 🌟: 76428, Total Fork 🌳: 30971
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 15182 | 7639 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 14754 | 7618 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5858 | 1422 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
| [ESP8266_RTOS_SDK](https://github.com/espressif/ESP8266_RTOS_SDK) | 3428 | 1584 | Latest ESP8266 SDK based on FreeRTOS, esp-idf style. |
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2215 | 849 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 2199 | 689 | None |
| [esp-adf](https://github.com/espressif/esp-adf) | 1885 | 762 | Espressif Advanced Development Framework |
| [esp-who](https://github.com/espressif/esp-who) | 1831 | 487 | Face detection and recognition framework |
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1214 | 323 | Visual Studio Code extension for ESP-IDF projects |
| [esp-drone](https://github.com/espressif/esp-drone) | 1083 | 283 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-at](https://github.com/espressif/esp-at) | 1007 | 960 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [esp-box](https://github.com/espressif/esp-box) | 987 | 225 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
| [ESP8266_NONOS_SDK](https://github.com/espressif/ESP8266_NONOS_SDK) | 955 | 543 | ESP8266 nonOS SDK |
| [esp-sr](https://github.com/espressif/esp-sr) | 914 | 141 | Speech recognition |
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 899 | 121 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
| [esp-matter](https://github.com/espressif/esp-matter) | 824 | 187 | Espressif's SDK for Matter |
| [esp-mdf](https://github.com/espressif/esp-mdf) | 809 | 254 | Espressif Mesh Development Framework, limited maintain, recommend to use https://github.com/espressif/esp-mesh-lite |
| [esp-hosted](https://github.com/espressif/esp-hosted) | 797 | 186 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
| [esp-csi](https://github.com/espressif/esp-csi) | 783 | 118 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
...
| [esp-dl](https://github.com/espressif/esp-dl) | 702 | 141 | Espressif deep-learning library for AIoT applications |
| [esp-skainet](https://github.com/espressif/esp-skainet) | 696 | 156 | Espressif intelligent voice assistant |
| [esp-mqtt](https://github.com/espressif/esp-mqtt) | 647 | 263 | ESP32 mqtt component |
| [esp-apple-homekit-adk](https://github.com/espressif/esp-apple-homekit-adk) | 639 | 69 | This is a port for Apple's Open Source HomeKit ADK |
| [esp-homekit-sdk](https://github.com/espressif/esp-homekit-sdk) | 612 | 115 | None |
...
| [esp-dsp](https://github.com/espressif/esp-dsp) | 548 | 97 | DSP library for ESP-IDF |
| [esp-rainmaker](https://github.com/espressif/esp-rainmaker) | 518 | 174 | ESP RainMaker Agent for firmware development |
| [esp-tflite-micro](https://github.com/espressif/esp-tflite-micro) | 479 | 103 | TensorFlow Lite Micro for Espressif Chipsets |
...
| [esp-dev-kits](https://github.com/espressif/esp-dev-kits) | 444 | 192 | Docs, Schematics, Factory Firmwares for ESP Development Kits |
...
| [openocd-esp32](https://github.com/espressif/openocd-esp32) | 395 | 145 | OpenOCD branch with ESP32 JTAG support |
| [esptool-js](https://github.com/espressif/esptool-js) | 349 | 118 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
...
| [idf-eclipse-plugin](https://github.com/espressif/idf-eclipse-plugin) | 335 | 128 | Espressif-IDE (ESP-IDF Eclipse Plugin) for ESP-IDF CMake based projects 5.x and above |
...
| [esp-bsp](https://github.com/espressif/esp-bsp) | 266 | 144 | Board support components for Espressif development boards |
| [esp-zigbee-sdk](https://github.com/espressif/esp-zigbee-sdk) | 262 | 48 | Espressif Zigbee SDK |
| [esp-protocols](https://github.com/espressif/esp-protocols) | 233 | 159 | Collection of ESP-IDF components related to networking protocols |
...
| [esp32-doom](https://github.com/espressif/esp32-doom) | 222 | 45 | A proof-of-concept port of PrBoom to the ESP32. Needs psram hardware. |
...
| [idf-extra-components](https://github.com/espressif/idf-extra-components) | 183 | 103 | Additional components for ESP-IDF, maintained by Espressif |
| [esp32-wifi-lib](https://github.com/espressif/esp32-wifi-lib) | 175 | 74 | ESP32 WiFi stack precompiled libraries |
| [esp32-arduino-lib-builder](https://github.com/espressif/esp32-arduino-lib-builder) | 171 | 181 | None |
| [esp-nn](https://github.com/espressif/esp-nn) | 168 | 27 | Optimised Neural Network functions for Espressif chipsets |
...
| [esp-thread-br](https://github.com/espressif/esp-thread-br) | 145 | 36 | Espressif Thread Border Router SDK |
| [esp-google-iot](https://github.com/espressif/esp-google-iot) | 143 | 46 | Google Cloud IoT SDK as an ESP-IDF Component |
| [esp-webrtc-solution](https://github.com/espressif/esp-webrtc-solution) | 136 | 16 | None |
| [esp8266-rtos-sample-code](https://github.com/espressif/esp8266-rtos-sample-code) | 129 | 87 | None |
| [book-esp32c3-iot-projects](https://github.com/espressif/book-esp32c3-iot-projects) | 124 | 41 | 《ESP32-C3 物联网工程开发实战》配套代码 |
...
| [esp-rainmaker-android](https://github.com/espressif/esp-rainmaker-android) | 119 | 64 | ESP RainMaker Android app sources |
...
| [esp-brookesia](https://github.com/espressif/esp-brookesia) | 85 | 11 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
...
| [freertos-gdb](https://github.com/espressif/freertos-gdb) | 61 | 11 | Python module for operating with freeRTOS kernel objects in GDB |
| [esp-moonlight](https://github.com/espressif/esp-moonlight) | 60 | 35 | None |
| [esp-launchpad](https://github.com/espressif/esp-launchpad) | 58 | 25 | Configurable Browser-based Image Flasher |
| [esp-rainmaker-ios](https://github.com/espressif/esp-rainmaker-ios) | 55 | 26 | ESP RainMaker iOS app sources |
...
| [esp32-c3-book-en](https://github.com/espressif/esp32-c3-book-en) | 47 | 5 | Read the book here: |
...
| [esp-usb](https://github.com/espressif/esp-usb) | 40 | 26 | None |
...
| [esp-gmf](https://github.com/espressif/esp-gmf) | 20 | 4 | Espressif General Multimedia Framework (ESP-GMF) |
...
| [esp-hosted-mcu](https://github.com/espressif/esp-hosted-mcu) | 12 | 2 | None |
...
| [esp-detection](https://github.com/espressif/esp-detection) | 10 | 0 | Lightweight real-time object detection on ESP series chips, based on Ultralytics YOLOv11 |
...
| [esp-idf-nvs-partition-gen](https://github.com/espressif/esp-idf-nvs-partition-gen) | 8 | 6 | NVS Partition Generator tool |
...
| [esp-wifi-remote](https://github.com/espressif/esp-wifi-remote) | 6 | 1 | Allows WiFi-enabled ESP capabilities on remote targets (without native WiFi) using designated transports |
| [esp-rainmaker-webhooks](https://github.com/espressif/esp-rainmaker-webhooks) | 5 | 3 | Rainmaker Web hooks Project |
| [jupyter-lite-micropython](https://github.com/espressif/jupyter-lite-micropython) | 5 | 1 | Jupyter Lite kernel for micropython and circuitpython |
