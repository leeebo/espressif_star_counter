# Espressif Systems Github Star Rank 2025-08-14

## Total Star 🌟: 80540, Total Fork 🌳: 31928
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 16008 | 7803 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 15220 | 7674 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 6002 | 1441 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
| [ESP8266_RTOS_SDK](https://github.com/espressif/ESP8266_RTOS_SDK) | 3459 | 1600 | Latest ESP8266 SDK based on FreeRTOS, esp-idf style. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 2329 | 718 | None |
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2326 | 881 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp-adf](https://github.com/espressif/esp-adf) | 2011 | 794 | Espressif Advanced Development Framework for Multimedia Applications |
| [esp-who](https://github.com/espressif/esp-who) | 1887 | 502 | Face detection and recognition framework |
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1275 | 332 | Visual Studio Code extension for ESP-IDF projects |
| [esp-drone](https://github.com/espressif/esp-drone) | 1205 | 317 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-box](https://github.com/espressif/esp-box) | 1070 | 239 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
| [esp-at](https://github.com/espressif/esp-at) | 1059 | 1035 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [esp-sr](https://github.com/espressif/esp-sr) | 1050 | 154 | Speech recognition |
| [ESP8266_NONOS_SDK](https://github.com/espressif/ESP8266_NONOS_SDK) | 962 | 543 | ESP8266 nonOS SDK |
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 962 | 133 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
| [esp-csi](https://github.com/espressif/esp-csi) | 866 | 125 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
| [esp-matter](https://github.com/espressif/esp-matter) | 866 | 198 | Espressif's SDK for Matter |
| [esp-hosted](https://github.com/espressif/esp-hosted) | 860 | 200 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
...
| [esp-dl](https://github.com/espressif/esp-dl) | 775 | 151 | Espressif deep-learning library for AIoT applications |
...
| [esp-mqtt](https://github.com/espressif/esp-mqtt) | 666 | 271 | ESP32 mqtt component |
| [esp-now](https://github.com/espressif/esp-now) | 651 | 110 | A connectionless Wi-Fi communication protocol |
...
| [esp-homekit-sdk](https://github.com/espressif/esp-homekit-sdk) | 630 | 119 | None |
| [esp32-nesemu](https://github.com/espressif/esp32-nesemu) | 586 | 178 | Proof-of-concept NES emulator for the ESP32 |
...
| [esp-tflite-micro](https://github.com/espressif/esp-tflite-micro) | 513 | 116 | TensorFlow Lite Micro for Espressif Chipsets |
| [esp-dev-kits](https://github.com/espressif/esp-dev-kits) | 490 | 202 | Docs, Schematics, Factory Firmwares for ESP Development Kits |
...
| [esp-serial-flasher](https://github.com/espressif/esp-serial-flasher) | 469 | 131 | Library for flashing Espressif SoCs from other MCUs. |
| [openocd-esp32](https://github.com/espressif/openocd-esp32) | 412 | 147 | OpenOCD branch with ESP32 JTAG support |
| [esptool-js](https://github.com/espressif/esptool-js) | 387 | 133 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
| [esp-brookesia](https://github.com/espressif/esp-brookesia) | 376 | 74 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
...
| [idf-eclipse-plugin](https://github.com/espressif/idf-eclipse-plugin) | 344 | 129 | Espressif-IDE (ESP-IDF Eclipse Plugin) for ESP-IDF CMake based projects 5.x and above |
| [esp-usb-bridge](https://github.com/espressif/esp-usb-bridge) | 338 | 37 | USB to UART&JTAG bridge, implemented on ESP32-S2 or ESP32-S3 |
| [esp-bsp](https://github.com/espressif/esp-bsp) | 315 | 157 | Board support components for Espressif development boards |
...
| [esp-zigbee-sdk](https://github.com/espressif/esp-zigbee-sdk) | 291 | 56 | Espressif Zigbee SDK |
| [esp-protocols](https://github.com/espressif/esp-protocols) | 252 | 169 | Collection of ESP-IDF components related to networking protocols |
...
| [esp-webrtc-solution](https://github.com/espressif/esp-webrtc-solution) | 235 | 37 | None |
...
| [esp-iot-bridge](https://github.com/espressif/esp-iot-bridge) | 198 | 66 | A smart bridge to make both ESP and the other MCU or smart device can access the Internet. |
...
| [esp-nn](https://github.com/espressif/esp-nn) | 181 | 29 | Optimised Neural Network functions for Espressif chipsets |
| [esp-mesh-lite](https://github.com/espressif/esp-mesh-lite) | 173 | 35 | A lite version Wi-Fi Mesh, each node can access the network over the IP layer. |
...
| [esp-modbus](https://github.com/espressif/esp-modbus) | 151 | 67 | ESP-Modbus - the officially suppported library for Modbus protocol (serial RS485 + TCP over WiFi or Ethernet). |
...
| [esp-insights](https://github.com/espressif/esp-insights) | 125 | 38 | ESP Insights: A remote diagnostics/observability framework for connected devices |
...
| [esp-gmf](https://github.com/espressif/esp-gmf) | 59 | 14 | Espressif General Multimedia Framework (ESP-GMF) |
...
| [esp-usb](https://github.com/espressif/esp-usb) | 52 | 30 | None |
...
| [esp-hosted-mcu](https://github.com/espressif/esp-hosted-mcu) | 41 | 12 | None |
...
| [esp-idf-security-dashboard](https://github.com/espressif/esp-idf-security-dashboard) | 2 | 0 | ESP-IDF Security Vulnerability Dashboard |
