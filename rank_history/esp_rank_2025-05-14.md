# Espressif Systems Github Star Rank 2025-05-14

## Total Star 🌟: 76475, Total Fork 🌳: 30985
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 15195 | 7647 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 14760 | 7616 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5860 | 1422 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
...
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2217 | 849 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 2202 | 689 | None |
| [esp-adf](https://github.com/espressif/esp-adf) | 1885 | 763 | Espressif Advanced Development Framework |
| [esp-who](https://github.com/espressif/esp-who) | 1831 | 488 | Face detection and recognition framework |
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1215 | 323 | Visual Studio Code extension for ESP-IDF projects |
| [esp-drone](https://github.com/espressif/esp-drone) | 1085 | 284 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-at](https://github.com/espressif/esp-at) | 1008 | 962 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
...
| [esp-sr](https://github.com/espressif/esp-sr) | 917 | 141 | Speech recognition |
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 900 | 122 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
| [esp-matter](https://github.com/espressif/esp-matter) | 824 | 188 | Espressif's SDK for Matter |
...
| [esp-hosted](https://github.com/espressif/esp-hosted) | 798 | 186 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
...
| [esp-dl](https://github.com/espressif/esp-dl) | 704 | 140 | Espressif deep-learning library for AIoT applications |
...
| [esp-dsp](https://github.com/espressif/esp-dsp) | 548 | 96 | DSP library for ESP-IDF |
...
| [esp-dev-kits](https://github.com/espressif/esp-dev-kits) | 445 | 192 | Docs, Schematics, Factory Firmwares for ESP Development Kits |
...
| [esptool-js](https://github.com/espressif/esptool-js) | 350 | 118 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
...
| [idf-eclipse-plugin](https://github.com/espressif/idf-eclipse-plugin) | 336 | 128 | Espressif-IDE (ESP-IDF Eclipse Plugin) for ESP-IDF CMake based projects 5.x and above |
...
| [esp-bsp](https://github.com/espressif/esp-bsp) | 268 | 145 | Board support components for Espressif development boards |
...
| [idf-extra-components](https://github.com/espressif/idf-extra-components) | 183 | 104 | Additional components for ESP-IDF, maintained by Espressif |
...
| [esp-webrtc-solution](https://github.com/espressif/esp-webrtc-solution) | 136 | 17 | None |
...
| [idf-installer](https://github.com/espressif/idf-installer) | 108 | 24 | ESP IDF Windows Installer |
...
| [esp32-c3-book-en](https://github.com/espressif/esp32-c3-book-en) | 47 | 4 | Read the book here: |
...
| [jupyter-lite-micropython](https://github.com/espressif/jupyter-lite-micropython) | 7 | 1 | Jupyter Lite kernel for micropython and circuitpython |
