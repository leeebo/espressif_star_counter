# Espressif Systems Github Star Rank 2025-07-26

## Total Star 🌟: 79731, Total Fork 🌳: 31751
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 15869 | 7779 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 15137 | 7661 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5972 | 1437 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
| [ESP8266_RTOS_SDK](https://github.com/espressif/ESP8266_RTOS_SDK) | 3455 | 1596 | Latest ESP8266 SDK based on FreeRTOS, esp-idf style. |
...
| [esp-adf](https://github.com/espressif/esp-adf) | 1982 | 785 | Espressif Advanced Development Framework for Multimedia Applications |
...
| [esp-box](https://github.com/espressif/esp-box) | 1050 | 237 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
| [esp-at](https://github.com/espressif/esp-at) | 1049 | 1018 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
...
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 951 | 131 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
| [esp-matter](https://github.com/espressif/esp-matter) | 851 | 196 | Espressif's SDK for Matter |
| [esp-hosted](https://github.com/espressif/esp-hosted) | 841 | 198 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
...
| [rust-esp32-example](https://github.com/espressif/rust-esp32-example) | 478 | 39 | Example of Rust integration into an ESP-IDF project, for ESP32 series of chips |
...
| [esptool-js](https://github.com/espressif/esptool-js) | 380 | 132 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
...
| [esp-brookesia](https://github.com/espressif/esp-brookesia) | 329 | 62 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
| [esp-bsp](https://github.com/espressif/esp-bsp) | 308 | 156 | Board support components for Espressif development boards |
...
| [esp-zigbee-sdk](https://github.com/espressif/esp-zigbee-sdk) | 285 | 54 | Espressif Zigbee SDK |
...
| [idf-extra-components](https://github.com/espressif/idf-extra-components) | 190 | 109 | Additional components for ESP-IDF, maintained by Espressif |
...
| [esp-nn](https://github.com/espressif/esp-nn) | 179 | 29 | Optimised Neural Network functions for Espressif chipsets |
...
| [esp-adf-libs](https://github.com/espressif/esp-adf-libs) | 85 | 50 | None |
...
| [esp-hosted-mcu](https://github.com/espressif/esp-hosted-mcu) | 35 | 12 | None |
...
| [esp-detection](https://github.com/espressif/esp-detection) | 33 | 3 | Lightweight real-time object detection on ESP series chips, based on Ultralytics YOLOv11 |
