# Espressif Systems Github Star Rank 2025-05-30

## Total Star 🌟: 77153, Total Fork 🌳: 31134
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 15325 | 7673 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 14849 | 7628 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5885 | 1429 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
...
| [esp32-camera](https://github.com/espressif/esp32-camera) | 2224 | 695 | None |
| [esp-adf](https://github.com/espressif/esp-adf) | 1908 | 767 | Espressif Advanced Development Framework |
| [esp-who](https://github.com/espressif/esp-who) | 1844 | 490 | Face detection and recognition framework |
...
| [esp-drone](https://github.com/espressif/esp-drone) | 1102 | 287 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
...
| [esp-sr](https://github.com/espressif/esp-sr) | 939 | 141 | Speech recognition |
...
| [esp-hosted](https://github.com/espressif/esp-hosted) | 806 | 190 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
| [esp-csi](https://github.com/espressif/esp-csi) | 789 | 118 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
...
| [esp-dl](https://github.com/espressif/esp-dl) | 716 | 140 | Espressif deep-learning library for AIoT applications |
| [esp-skainet](https://github.com/espressif/esp-skainet) | 710 | 160 | Espressif intelligent voice assistant |
...
| [esptool-js](https://github.com/espressif/esptool-js) | 354 | 123 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
...
| [esp-protocols](https://github.com/espressif/esp-protocols) | 234 | 160 | Collection of ESP-IDF components related to networking protocols |
...
| [esp-webrtc-solution](https://github.com/espressif/esp-webrtc-solution) | 189 | 26 | None |
...
| [esp-nn](https://github.com/espressif/esp-nn) | 170 | 28 | Optimised Neural Network functions for Espressif chipsets |
...
| [esp-adf-libs](https://github.com/espressif/esp-adf-libs) | 78 | 48 | None |
...
| [openocd-on-esp32](https://github.com/espressif/openocd-on-esp32) | 71 | 7 | OpenOCD port running on ESP32-S3 microcontrollers |
...
| [esp-launchpad](https://github.com/espressif/esp-launchpad) | 60 | 26 | Configurable Browser-based Image Flasher |
...
| [esp32-c3-book-en](https://github.com/espressif/esp32-c3-book-en) | 50 | 4 | Read the book here: |
