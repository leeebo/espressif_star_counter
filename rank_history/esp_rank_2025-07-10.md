# Espressif Systems Github Star Rank 2025-07-10

## Total Star 🌟: 79008, Total Fork 🌳: 31552
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 15757 | 7751 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 15041 | 7657 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5953 | 1435 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
...
| [esp32-camera](https://github.com/espressif/esp32-camera) | 2280 | 708 | None |
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2279 | 870 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp-adf](https://github.com/espressif/esp-adf) | 1963 | 779 | Espressif Advanced Development Framework |
| [esp-who](https://github.com/espressif/esp-who) | 1867 | 494 | Face detection and recognition framework |
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1255 | 330 | Visual Studio Code extension for ESP-IDF projects |
| [esp-drone](https://github.com/espressif/esp-drone) | 1163 | 303 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-box](https://github.com/espressif/esp-box) | 1042 | 234 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
| [esp-at](https://github.com/espressif/esp-at) | 1036 | 1003 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [esp-sr](https://github.com/espressif/esp-sr) | 1005 | 151 | Speech recognition |
| [ESP8266_NONOS_SDK](https://github.com/espressif/ESP8266_NONOS_SDK) | 961 | 542 | ESP8266 nonOS SDK |
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 934 | 130 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
| [esp-matter](https://github.com/espressif/esp-matter) | 844 | 195 | Espressif's SDK for Matter |
| [esp-hosted](https://github.com/espressif/esp-hosted) | 833 | 195 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
| [esp-csi](https://github.com/espressif/esp-csi) | 815 | 120 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
...
| [esp-dl](https://github.com/espressif/esp-dl) | 738 | 143 | Espressif deep-learning library for AIoT applications |
| [esp-skainet](https://github.com/espressif/esp-skainet) | 731 | 163 | Espressif intelligent voice assistant |
...
| [esp-homekit-sdk](https://github.com/espressif/esp-homekit-sdk) | 623 | 118 | None |
| [esp32-nesemu](https://github.com/espressif/esp32-nesemu) | 579 | 176 | Proof-of-concept NES emulator for the ESP32 |
| [esp-dsp](https://github.com/espressif/esp-dsp) | 565 | 99 | DSP library for ESP-IDF |
| [esp-rainmaker](https://github.com/espressif/esp-rainmaker) | 532 | 183 | ESP RainMaker Agent for firmware development |
| [esp-tflite-micro](https://github.com/espressif/esp-tflite-micro) | 498 | 108 | TensorFlow Lite Micro for Espressif Chipsets |
...
| [openocd-esp32](https://github.com/espressif/openocd-esp32) | 403 | 146 | OpenOCD branch with ESP32 JTAG support |
| [esptool-js](https://github.com/espressif/esptool-js) | 372 | 128 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
...
| [esp-bsp](https://github.com/espressif/esp-bsp) | 301 | 153 | Board support components for Espressif development boards |
| [esp-aws-iot](https://github.com/espressif/esp-aws-iot) | 300 | 180 | AWS IoT SDK for ESP32 based chipsets |
| [esp-zigbee-sdk](https://github.com/espressif/esp-zigbee-sdk) | 279 | 53 | Espressif Zigbee SDK |
| [esp-brookesia](https://github.com/espressif/esp-brookesia) | 268 | 39 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
| [esp-protocols](https://github.com/espressif/esp-protocols) | 241 | 164 | Collection of ESP-IDF components related to networking protocols |
| [esp32-doom](https://github.com/espressif/esp32-doom) | 236 | 48 | A proof-of-concept port of PrBoom to the ESP32. Needs psram hardware. |
...
| [esp-iot-bridge](https://github.com/espressif/esp-iot-bridge) | 193 | 64 | A smart bridge to make both ESP and the other MCU or smart device can access the Internet. |
...
| [idf-extra-components](https://github.com/espressif/idf-extra-components) | 189 | 106 | Additional components for ESP-IDF, maintained by Espressif |
...
| [esp-gmf](https://github.com/espressif/esp-gmf) | 43 | 12 | Espressif General Multimedia Framework (ESP-GMF) |
...
| [esp-hosted-mcu](https://github.com/espressif/esp-hosted-mcu) | 29 | 10 | None |
...
| [idf-clion-plugin](https://github.com/espressif/idf-clion-plugin) | 22 | 5 | CLion plugin for ESP-IDF |
