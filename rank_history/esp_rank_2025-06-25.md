# Espressif Systems Github Star Rank 2025-06-25

## Total Star 🌟: 78377, Total Fork 🌳: 31369
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 15631 | 7716 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 14960 | 7645 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5923 | 1434 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
| [ESP8266_RTOS_SDK](https://github.com/espressif/ESP8266_RTOS_SDK) | 3445 | 1587 | Latest ESP8266 SDK based on FreeRTOS, esp-idf style. |
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2266 | 866 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 2260 | 700 | None |
| [esp-adf](https://github.com/espressif/esp-adf) | 1948 | 773 | Espressif Advanced Development Framework |
| [esp-who](https://github.com/espressif/esp-who) | 1863 | 492 | Face detection and recognition framework |
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1245 | 329 | Visual Studio Code extension for ESP-IDF projects |
| [esp-drone](https://github.com/espressif/esp-drone) | 1136 | 295 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
...
| [esp-at](https://github.com/espressif/esp-at) | 1026 | 990 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
...
| [esp-matter](https://github.com/espressif/esp-matter) | 837 | 194 | Espressif's SDK for Matter |
| [esp-hosted](https://github.com/espressif/esp-hosted) | 827 | 192 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
...
| [esp-csi](https://github.com/espressif/esp-csi) | 800 | 119 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
...
| [esp-dl](https://github.com/espressif/esp-dl) | 733 | 142 | Espressif deep-learning library for AIoT applications |
...
| [esp-rainmaker](https://github.com/espressif/esp-rainmaker) | 530 | 180 | ESP RainMaker Agent for firmware development |
...
| [esptool-js](https://github.com/espressif/esptool-js) | 364 | 126 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
...
| [esp-aws-iot](https://github.com/espressif/esp-aws-iot) | 297 | 179 | AWS IoT SDK for ESP32 based chipsets |
| [esp-bsp](https://github.com/espressif/esp-bsp) | 295 | 150 | Board support components for Espressif development boards |
...
| [esp-brookesia](https://github.com/espressif/esp-brookesia) | 232 | 26 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
...
| [esp-thread-br](https://github.com/espressif/esp-thread-br) | 151 | 36 | Espressif Thread Border Router SDK |
...
| [esp-rainmaker-android](https://github.com/espressif/esp-rainmaker-android) | 122 | 65 | ESP RainMaker Android app sources |
