# Espressif Systems Github Star Rank 2025-09-29

## Total Star 🌟: 82263, Total Fork 🌳: 32350
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 16295 | 7884 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 15466 | 7711 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 6063 | 1451 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
...
| [esp32-camera](https://github.com/espressif/esp32-camera) | 2376 | 723 | None |
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2364 | 904 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp-adf](https://github.com/espressif/esp-adf) | 2051 | 806 | Espressif Advanced Development Framework for Multimedia Applications |
| [esp-who](https://github.com/espressif/esp-who) | 1915 | 508 | Face detection and recognition framework |
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1301 | 335 | Visual Studio Code extension for ESP-IDF projects |
| [esp-drone](https://github.com/espressif/esp-drone) | 1279 | 332 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-sr](https://github.com/espressif/esp-sr) | 1121 | 163 | Speech recognition |
| [esp-box](https://github.com/espressif/esp-box) | 1107 | 247 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
| [esp-at](https://github.com/espressif/esp-at) | 1087 | 1067 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 1000 | 136 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
| [ESP8266_NONOS_SDK](https://github.com/espressif/ESP8266_NONOS_SDK) | 964 | 544 | ESP8266 nonOS SDK |
| [esp-csi](https://github.com/espressif/esp-csi) | 915 | 128 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
| [esp-matter](https://github.com/espressif/esp-matter) | 889 | 199 | Espressif's SDK for Matter |
| [esp-hosted](https://github.com/espressif/esp-hosted) | 882 | 203 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
| [esp-mdf](https://github.com/espressif/esp-mdf) | 819 | 257 | Espressif Mesh Development Framework, limited maintain, recommend to use https://github.com/espressif/esp-mesh-lite |
| [esp-dl](https://github.com/espressif/esp-dl) | 799 | 157 | Espressif deep-learning library for AIoT applications |
...
| [esp-now](https://github.com/espressif/esp-now) | 672 | 113 | A connectionless Wi-Fi communication protocol |
...
| [esp-dsp](https://github.com/espressif/esp-dsp) | 597 | 106 | DSP library for ESP-IDF |
| [esp32-nesemu](https://github.com/espressif/esp32-nesemu) | 589 | 180 | Proof-of-concept NES emulator for the ESP32 |
| [esp-rainmaker](https://github.com/espressif/esp-rainmaker) | 556 | 190 | ESP RainMaker Agent for firmware development |
| [esp-tflite-micro](https://github.com/espressif/esp-tflite-micro) | 536 | 123 | TensorFlow Lite Micro for Espressif Chipsets |
...
| [esp-serial-flasher](https://github.com/espressif/esp-serial-flasher) | 486 | 132 | Library for flashing Espressif SoCs from other MCUs. |
...
| [esp-brookesia](https://github.com/espressif/esp-brookesia) | 434 | 98 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
| [openocd-esp32](https://github.com/espressif/openocd-esp32) | 422 | 149 | OpenOCD branch with ESP32 JTAG support |
| [esptool-js](https://github.com/espressif/esptool-js) | 407 | 138 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
...
| [idf-eclipse-plugin](https://github.com/espressif/idf-eclipse-plugin) | 346 | 130 | Espressif-IDE (ESP-IDF Eclipse Plugin) for ESP-IDF CMake based projects 5.x and above |
| [esp-bsp](https://github.com/espressif/esp-bsp) | 334 | 169 | Board support components for Espressif development boards |
| [esp-aws-iot](https://github.com/espressif/esp-aws-iot) | 310 | 184 | AWS IoT SDK for ESP32 based chipsets |
...
| [esp-zigbee-sdk](https://github.com/espressif/esp-zigbee-sdk) | 301 | 60 | Espressif Zigbee SDK |
| [esp-webrtc-solution](https://github.com/espressif/esp-webrtc-solution) | 266 | 47 | None |
| [esp-protocols](https://github.com/espressif/esp-protocols) | 258 | 171 | Collection of ESP-IDF components related to networking protocols |
...
| [esp-iot-bridge](https://github.com/espressif/esp-iot-bridge) | 204 | 67 | A smart bridge to make both ESP and the other MCU or smart device can access the Internet. |
...
| [esp-wasmachine](https://github.com/espressif/esp-wasmachine) | 108 | 9 | The Machine which can run WASM applications. |
| [usb-pids](https://github.com/espressif/usb-pids) | 108 | 167 | Customer-allocated USB PIDs under the Espressif VID |
...
| [esp-gmf](https://github.com/espressif/esp-gmf) | 67 | 15 | Espressif General Multimedia Framework (ESP-GMF) |
...
| [esp-detection](https://github.com/espressif/esp-detection) | 50 | 3 | Lightweight real-time object detection on ESP series chips, based on Ultralytics YOLOv11 |
...
| [esp-idf-monitor](https://github.com/espressif/esp-idf-monitor) | 32 | 13 | None |
...
| [esp-wifi-remote](https://github.com/espressif/esp-wifi-remote) | 16 | 3 | Allows WiFi-enabled ESP capabilities on remote targets (without native WiFi) using designated transports |
