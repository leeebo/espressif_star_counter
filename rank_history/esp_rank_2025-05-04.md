# Espressif Systems Github Star Rank 2025-05-04

## Total Star 🌟: 76091, Total Fork 🌳: 30884
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 15118 | 7625 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 14717 | 7609 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5843 | 1421 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
...
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1204 | 320 | Visual Studio Code extension for ESP-IDF projects |
| [esp-drone](https://github.com/espressif/esp-drone) | 1071 | 280 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
...
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 889 | 118 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
...
| [esp-modbus](https://github.com/espressif/esp-modbus) | 141 | 61 | ESP-Modbus - the officially suppported library for Modbus protocol (serial RS485 + TCP over WiFi or Ethernet). |
...
| [esp-insights](https://github.com/espressif/esp-insights) | 124 | 35 | ESP Insights: A remote diagnostics/observability framework for connected devices |
