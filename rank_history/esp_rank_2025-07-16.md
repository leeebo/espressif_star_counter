# Espressif Systems Github Star Rank 2025-07-16

## Total Star 🌟: 79243, Total Fork 🌳: 31621
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 15799 | 7759 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 15078 | 7660 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5961 | 1436 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
...
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2290 | 873 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 2289 | 708 | None |
| [esp-adf](https://github.com/espressif/esp-adf) | 1970 | 781 | Espressif Advanced Development Framework for Multimedia Applications |
| [esp-who](https://github.com/espressif/esp-who) | 1869 | 496 | Face detection and recognition framework |
...
| [esp-drone](https://github.com/espressif/esp-drone) | 1171 | 306 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-box](https://github.com/espressif/esp-box) | 1044 | 236 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
| [esp-at](https://github.com/espressif/esp-at) | 1037 | 1008 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [esp-sr](https://github.com/espressif/esp-sr) | 1012 | 154 | Speech recognition |
| [ESP8266_NONOS_SDK](https://github.com/espressif/ESP8266_NONOS_SDK) | 962 | 542 | ESP8266 nonOS SDK |
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 938 | 130 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
| [esp-matter](https://github.com/espressif/esp-matter) | 847 | 196 | Espressif's SDK for Matter |
| [esp-hosted](https://github.com/espressif/esp-hosted) | 835 | 194 | Hosted Solution (Linux/MCU) with ESP32 (Wi-Fi + BT + BLE) |
| [esp-csi](https://github.com/espressif/esp-csi) | 823 | 122 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
...
| [esp-dl](https://github.com/espressif/esp-dl) | 745 | 143 | Espressif deep-learning library for AIoT applications |
| [esp-skainet](https://github.com/espressif/esp-skainet) | 732 | 165 | Espressif intelligent voice assistant |
| [esp-mqtt](https://github.com/espressif/esp-mqtt) | 659 | 267 | ESP32 mqtt component |
...
| [esp-now](https://github.com/espressif/esp-now) | 630 | 108 | A connectionless Wi-Fi communication protocol |
...
| [esp-rainmaker](https://github.com/espressif/esp-rainmaker) | 533 | 184 | ESP RainMaker Agent for firmware development |
| [esp-tflite-micro](https://github.com/espressif/esp-tflite-micro) | 500 | 108 | TensorFlow Lite Micro for Espressif Chipsets |
...
| [esp-dev-kits](https://github.com/espressif/esp-dev-kits) | 469 | 197 | Docs, Schematics, Factory Firmwares for ESP Development Kits |
...
| [openocd-esp32](https://github.com/espressif/openocd-esp32) | 406 | 146 | OpenOCD branch with ESP32 JTAG support |
| [esptool-js](https://github.com/espressif/esptool-js) | 374 | 131 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
...
| [idf-eclipse-plugin](https://github.com/espressif/idf-eclipse-plugin) | 342 | 130 | Espressif-IDE (ESP-IDF Eclipse Plugin) for ESP-IDF CMake based projects 5.x and above |
...
| [esp-brookesia](https://github.com/espressif/esp-brookesia) | 292 | 52 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
| [esp-zigbee-sdk](https://github.com/espressif/esp-zigbee-sdk) | 281 | 53 | Espressif Zigbee SDK |
| [esp-protocols](https://github.com/espressif/esp-protocols) | 243 | 164 | Collection of ESP-IDF components related to networking protocols |
...
| [esp-idf-provisioning-android](https://github.com/espressif/esp-idf-provisioning-android) | 234 | 151 | Android Provisioning application for ESP-IDF Unified provisioning |
| [esp-webrtc-solution](https://github.com/espressif/esp-webrtc-solution) | 217 | 33 | None |
| [esp-iot-bridge](https://github.com/espressif/esp-iot-bridge) | 195 | 65 | A smart bridge to make both ESP and the other MCU or smart device can access the Internet. |
...
| [esp32-arduino-lib-builder](https://github.com/espressif/esp32-arduino-lib-builder) | 177 | 184 | None |
...
| [esp-idf-provisioning-ios](https://github.com/espressif/esp-idf-provisioning-ios) | 150 | 70 | None |
...
| [esp-insights](https://github.com/espressif/esp-insights) | 123 | 38 | ESP Insights: A remote diagnostics/observability framework for connected devices |
...
| [esp-detection](https://github.com/espressif/esp-detection) | 29 | 1 | Lightweight real-time object detection on ESP series chips, based on Ultralytics YOLOv11 |
