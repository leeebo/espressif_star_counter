# Espressif Systems Github Star Rank 2025-06-30

## Total Star 🌟: 78574, Total Fork 🌳: 31438
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 15674 | 7731 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 14979 | 7648 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5931 | 1435 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
| [ESP8266_RTOS_SDK](https://github.com/espressif/ESP8266_RTOS_SDK) | 3449 | 1590 | Latest ESP8266 SDK based on FreeRTOS, esp-idf style. |
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2271 | 868 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 2265 | 702 | None |
| [esp-adf](https://github.com/espressif/esp-adf) | 1954 | 774 | Espressif Advanced Development Framework |
| [esp-who](https://github.com/espressif/esp-who) | 1865 | 492 | Face detection and recognition framework |
| [vscode-esp-idf-extension](https://github.com/espressif/vscode-esp-idf-extension) | 1248 | 329 | Visual Studio Code extension for ESP-IDF projects |
| [esp-drone](https://github.com/espressif/esp-drone) | 1148 | 300 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-box](https://github.com/espressif/esp-box) | 1034 | 233 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
| [esp-at](https://github.com/espressif/esp-at) | 1028 | 992 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [esp-sr](https://github.com/espressif/esp-sr) | 985 | 148 | Speech recognition |
| [ESP8266_NONOS_SDK](https://github.com/espressif/ESP8266_NONOS_SDK) | 959 | 542 | ESP8266 nonOS SDK |
| [kicad-libraries](https://github.com/espressif/kicad-libraries) | 929 | 129 | KiCad libraries for Espressif SoCs, modules, and DevKits. |
| [esp-matter](https://github.com/espressif/esp-matter) | 840 | 195 | Espressif's SDK for Matter |
...
| [esp-csi](https://github.com/espressif/esp-csi) | 804 | 119 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
...
| [esp-dl](https://github.com/espressif/esp-dl) | 737 | 144 | Espressif deep-learning library for AIoT applications |
| [esp-skainet](https://github.com/espressif/esp-skainet) | 724 | 163 | Espressif intelligent voice assistant |
| [esp-mqtt](https://github.com/espressif/esp-mqtt) | 657 | 267 | ESP32 mqtt component |
...
| [esp-homekit-sdk](https://github.com/espressif/esp-homekit-sdk) | 620 | 118 | None |
...
| [esp-rainmaker](https://github.com/espressif/esp-rainmaker) | 531 | 182 | ESP RainMaker Agent for firmware development |
| [esp-tflite-micro](https://github.com/espressif/esp-tflite-micro) | 496 | 105 | TensorFlow Lite Micro for Espressif Chipsets |
| [rust-esp32-example](https://github.com/espressif/rust-esp32-example) | 476 | 40 | Example of Rust integration into an ESP-IDF project, for ESP32 series of chips |
...
| [esp-dev-kits](https://github.com/espressif/esp-dev-kits) | 463 | 194 | Docs, Schematics, Factory Firmwares for ESP Development Kits |
| [esp-serial-flasher](https://github.com/espressif/esp-serial-flasher) | 456 | 126 | Library for flashing Espressif SoCs from other MCUs. |
| [openocd-esp32](https://github.com/espressif/openocd-esp32) | 402 | 146 | OpenOCD branch with ESP32 JTAG support |
| [esptool-js](https://github.com/espressif/esptool-js) | 367 | 128 | Javascript implementation of flasher tool for Espressif chips, running in web browser using WebSerial. |
...
| [esp-aws-iot](https://github.com/espressif/esp-aws-iot) | 297 | 180 | AWS IoT SDK for ESP32 based chipsets |
| [esp-bsp](https://github.com/espressif/esp-bsp) | 295 | 153 | Board support components for Espressif development boards |
| [esp-zigbee-sdk](https://github.com/espressif/esp-zigbee-sdk) | 277 | 51 | Espressif Zigbee SDK |
| [esp-protocols](https://github.com/espressif/esp-protocols) | 239 | 162 | Collection of ESP-IDF components related to networking protocols |
| [esp-brookesia](https://github.com/espressif/esp-brookesia) | 236 | 27 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
| [esp-idf-provisioning-android](https://github.com/espressif/esp-idf-provisioning-android) | 233 | 150 | Android Provisioning application for ESP-IDF Unified provisioning |
| [esp32-doom](https://github.com/espressif/esp32-doom) | 231 | 49 | A proof-of-concept port of PrBoom to the ESP32. Needs psram hardware. |
| [esp-webrtc-solution](https://github.com/espressif/esp-webrtc-solution) | 210 | 29 | None |
| [esp-iot-bridge](https://github.com/espressif/esp-iot-bridge) | 191 | 64 | A smart bridge to make both ESP and the other MCU or smart device can access the Internet. |
...
| [esp-mesh-lite](https://github.com/espressif/esp-mesh-lite) | 172 | 32 | A lite version Wi-Fi Mesh, each node can access the network over the IP layer. |
...
| [esp-modbus](https://github.com/espressif/esp-modbus) | 147 | 63 | ESP-Modbus - the officially suppported library for Modbus protocol (serial RS485 + TCP over WiFi or Ethernet). |
...
| [esp-rainmaker-android](https://github.com/espressif/esp-rainmaker-android) | 122 | 69 | ESP RainMaker Android app sources |
...
| [esp-gmf](https://github.com/espressif/esp-gmf) | 40 | 11 | Espressif General Multimedia Framework (ESP-GMF) |
...
| [esp-debug-adapter](https://github.com/espressif/esp-debug-adapter) | 28 | 14 | An implementation of Microsoft Debug Adapter Protocol server which works with GDB. |
| [esp-hosted-mcu](https://github.com/espressif/esp-hosted-mcu) | 28 | 8 | None |
...
| [esp-detection](https://github.com/espressif/esp-detection) | 26 | 1 | Lightweight real-time object detection on ESP series chips, based on Ultralytics YOLOv11 |
...
| [gh-esp-test-template](https://github.com/espressif/gh-esp-test-template) | 13 | 13 | ESP Project Testing Template (CI Project Template/Demo) |
...
| [esp-idf-kconfig](https://github.com/espressif/esp-idf-kconfig) | 7 | 4 | None |
...
| [esp-bist](https://github.com/espressif/esp-bist) | 5 | 2 | Bist Library for Espressif Devices |
...
| [esp-llvm-embedded-toolchain](https://github.com/espressif/esp-llvm-embedded-toolchain) | 1 | 1 | Scripts and tools for building LLVM based toolchain. Forked from https://github.com/ARM-software/LLVM-embedded-toolchain-for-Arm |
