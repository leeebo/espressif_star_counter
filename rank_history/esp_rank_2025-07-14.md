# Espressif Systems Github Star Rank 2025-07-14

## Total Star 🌟: 79164, Total Fork 🌳: 31589
...
|------------|-------|-------|-------------|
| [esp-idf](https://github.com/espressif/esp-idf) | 15786 | 7752 | Espressif IoT Development Framework. Official development framework for Espressif SoCs. |
| [arduino-esp32](https://github.com/espressif/arduino-esp32) | 15064 | 7659 | Arduino core for the ESP32 |
| [esptool](https://github.com/espressif/esptool) | 5960 | 1436 | Serial utility for flashing, provisioning, and interacting with Espressif SoCs |
...
| [esp-iot-solution](https://github.com/espressif/esp-iot-solution) | 2288 | 872 | Espressif IoT Library. IoT Device Drivers, Documentations and Solutions. |
| [esp32-camera](https://github.com/espressif/esp32-camera) | 2285 | 709 | None |
...
| [esp-drone](https://github.com/espressif/esp-drone) | 1167 | 305 | Mini Drone/Quadcopter Firmware for ESP32 and ESP32-S Series SoCs. |
| [esp-box](https://github.com/espressif/esp-box) | 1044 | 235 | The ESP-BOX is a new generation AIoT development platform released by Espressif Systems. |
| [esp-at](https://github.com/espressif/esp-at) | 1037 | 1006 | AT application for ESP32/ESP32-C2/ESP32-C3/ESP32-C6/ESP8266 |
| [esp-sr](https://github.com/espressif/esp-sr) | 1012 | 152 | Speech recognition |
...
| [esp-csi](https://github.com/espressif/esp-csi) | 819 | 122 | Applications based on Wi-Fi CSI (Channel state information), such as indoor positioning, human detection |
...
| [esp-usb-bridge](https://github.com/espressif/esp-usb-bridge) | 334 | 37 | USB to UART&JTAG bridge, implemented on ESP32-S2 or ESP32-S3 |
| [esp-bsp](https://github.com/espressif/esp-bsp) | 303 | 154 | Board support components for Espressif development boards |
...
| [esp-brookesia](https://github.com/espressif/esp-brookesia) | 287 | 49 | ESP-Brookesia is a human-machine interaction development framework designed for AIoT devices. |
...
| [esp-idf-provisioning-ios](https://github.com/espressif/esp-idf-provisioning-ios) | 150 | 69 | None |
| [esp-modbus](https://github.com/espressif/esp-modbus) | 149 | 64 | ESP-Modbus - the officially suppported library for Modbus protocol (serial RS485 + TCP over WiFi or Ethernet). |
...
| [esp-gmf](https://github.com/espressif/esp-gmf) | 47 | 12 | Espressif General Multimedia Framework (ESP-GMF) |
